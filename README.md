...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-barcode-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-barcode-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-barcode
# for installing globally
pixi global install python-barcode
```
...
It is possible to list all of the versions of `python-barcode` available on your platform:
...
```
pixi search python-barcode --channel conda-forge
```
